<script>
  ...
  function setOS(newOS) {
    os = newOS;
    if (os === 'windows') installCommand = 'iwr https://get.wasome.org/install.ps1 | iex';
    else installCommand = 'curl -fsSL https://get.wasome.org/install.sh | sh';
  }
</script>

<div class="install-page" in:fade>
  <div class="container">
    ...
    <div class="install-card">
      ...
      <div class="manual-select">
        ...
        <div class="os-buttons">
          <button class:active={os === 'linux'} on:click={() => setOS('linux')}>Linux</button>
          <button class:active={os === 'mac'} on:click={() => setOS('mac')}>macOS</button>
          <button class:active={os === 'windows'} on:click={() => setOS('windows')}>Windows</button>
        </div>
      </div>
    </div>
    ...
    <div class="next-steps-grid">
      ...
      <div class="step-card">
        <h3>📚 Documentation</h3>
        <p>Ready to build? Check out the <a href="#/docs">official docs</a> to start your first project.</p>
      </div>
      <div class="step-card">
        <h3>🔧 Requirements</h3>
        <p>Wasome requires Git and a standard C compiler (gcc/clang) for native builds.</p>
      </div>
    </div>
...
<style>
  ...
  .gradient-text {
    background: linear-gradient(135deg, var(--primary) 0%, var(--secondary, #F59E0B) 100%);
  ...
  @media (max-width: 640px) {
    ...
    .copy-btn { padding: 1rem; justify-content: center; }
  }
</style>