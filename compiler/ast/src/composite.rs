...
{
    pub fn new(symbol: Rc<StructSymbol>, functions: Vec<ASTNode<Function<Type>>>, fields: Vec<ASTNode<StructField<Type>>>) -> Self {
        Self { symbol, functions, fields }
    }
    ...
    */
    pub(crate) fn function_symbol(&self, name: &str, only_public: bool) -> Option<&FunctionSymbol<Type>> {
