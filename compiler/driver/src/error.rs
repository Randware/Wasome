...
impl DriverError {
    /// Creates a [`DriverError::MainFileNonUtf8Chars`] error.
    ///
    /// This error indicates that the main file path contains invalid UTF-8 characters.
    ///
    /// # Returns
    ///
    ...
    /// Creates a [`DriverError::MainFileProjectNotFound`] error.
    ///
    /// This error indicates that the project containing the main file was not found
    ...
    /// Creates a [`DriverError::MainFilePathEmpty`] error.
    ///
    /// This error indicates that the main file path does not specify a valid file.
    ///
    /// # Returns
    ///
    ...
    /// Creates a [`DriverError::UnableToLoadFile`] error.
    ///
    /// This error indicates that the driver failed to load a source file from
    /// the file system.
    ///
    /// # Parameters
    ///
    /// - `path`: The absolute path of the file that could not be loaded.
    /// - `error`: The underlying I/O error that caused the failure.
    ///
    /// # Returns
    ///
    ...
    /// Creates a [`DriverError::UnableToLoadDirectory`] error.
    ///
    /// This error indicates that the driver failed to load a directory when
    /// resolving imports.
    ///
    /// # Parameters
    ///
    ...
    /// # Returns
    ///
    /// A `DriverError` variant containing the directory path and error details.
    ///
    /// # Note
    ///
    ...
    /// Creates a [`DriverError::UnresolvedImport`] error.
    ///
    /// This error indicates that an import statement references a module that
    /// cannot be found.
    ///
    /// # Parameters
    ///
